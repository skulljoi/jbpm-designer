package org.jbpm.designer.web.server.integration.base;

import static junit.framework.Assert.assertTrue;
import static org.jbpm.designer.web.server.integration.util.ArquillianDeploymentUtil.*;
...
import org.jbpm.designer.web.server.integration.util.GuvnorInterfaceUtil;
...
public abstract class AbstractGuvnorIntegrationTest {
    ...
    protected static StringBuilder readFile(String resourcePath) throws IOException {
        InputStream is = AbstractGuvnorIntegrationTest.class.getResourceAsStream(resourcePath);
